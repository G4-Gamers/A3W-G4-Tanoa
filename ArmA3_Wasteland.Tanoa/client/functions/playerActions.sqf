...
// Fireworks addAction Menu
/*
firebase addAction ["<t color=""#93E352"">Shoot random Fireworks!!</t>",{[[getPos (startpositions call BIS_fnc_selectRandom), 'random','random'],"A3W_fnc_fireworks",true,true] spawn BIS_fnc_MP; }, _Args, 1, false, false, "","_target distance _this < 1.5"];
firebase2 addAction ["<t color=""#93E352"">Shoot random Fireworks!!</t>",{[[getPos (startpositions2 call BIS_fnc_selectRandom), 'random','random'],"A3W_fnc_fireworks",true,true] spawn BIS_fnc_MP; }, _Args, 1, false, false, "","_target distance _this < 1.5"];
firebase3 addAction ["<t color=""#93E352"">Shoot random Fireworks!!</t>",{[[getPos (startpositions3 call BIS_fnc_selectRandom), 'random','random'],"A3W_fnc_fireworks",true,true] spawn BIS_fnc_MP; }, _Args, 1, false, false, "","_target distance _this < 1.5"];
*/