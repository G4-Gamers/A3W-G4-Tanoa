...
/*
	...
	if (_survivalSystem) then {
		_strArray pushBack format ["%1 <img size='0.7' image='client\icons\thirst.paa'/>", ceil (thirstLevel max 0)];
		_strArray pushBack format ["%1 <img size='0.7' image='client\icons\hunger.paa'/>", ceil (hungerLevel max 0)];
	};
